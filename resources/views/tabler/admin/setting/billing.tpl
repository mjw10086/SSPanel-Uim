                        ...
                        <div class="card-body">
                            <div class="tab-content">
                                ...
                                <div class="tab-pane" id="cryptomus">
                                    <div class="card-body">
                                        <div class="form-group mb-3 row">
                                            <label class="form-label col-3 col-form-label">Merchant UUID</label>
                                            <div class="col">
                                                <input id="cryptomus_merchant_uuid" type="text" class="form-control"
                                                    value="{$settings['cryptomus_merchant_uuid']}">
                                            </div>
                                        </div>
                                        <div class="form-group mb-3 row">
                                            <label class="form-label col-3 col-form-label">Payment Key</label>
                                            <div class="col">
                                                <input id="cryptomus_payment_key" type="text" class="form-control"
