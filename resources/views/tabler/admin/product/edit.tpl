                ...
                <div class="col-md-6 col-sm-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div id="time_option" class="form-group mb-3 row">
                                <label class="form-label col-3 col-form-label required">Description</label>
                                <div class="col">
                                    <input id="description" type="text" class="form-control" value="{$content->description}">
                                </div>
                            </div>
                            ...
                            <div id="time_option" class="form-group mb-3 row">
                                <label class="form-label col-3 col-form-label required">features</label>
                                <div class="col">
                                    <input id="features" type="text" class="form-control" value="{$content->features}">
                                </div>
                            </div>
                            <div class="hr-text">
                                <span>购买限制</span>
