<div class="card rounded-4 bg-tertiary text-light px-5 py-3 fw-normal">
    ...
    <div class="mb-4">
        ...
        <div class="px-5">
            <div class="input-group">
                <input class="form-control p-3 fs-6 fw-normal bg-quaternary border-0 text-light" disabled="true"
                    value="453ddhgvh787bjhbdsfsasashkahskjsahjdadadc" />
                <span class="input-group-text fs-7 fw-light bg-quaternary border-0 text-light">copy<i
                        class="bi bi-copy ms-1"></i></span>
            </div>
            <div class="text-gray fw-light fs-6 mt-1 d-flex justify-content-between fw-light text-gray">
                ...
                <span class="text-warning fw-normal">00:27</span>
            </div>
        </div>
    </div>
    <div class="mb-4">
    ...
    <div>
        ...
        <div class="px-5">
            <button class="my-3 btn btn-default w-100 fs-5 fw-normal">Generate activation
                code</button>
        </div>
    </div>
</div>
