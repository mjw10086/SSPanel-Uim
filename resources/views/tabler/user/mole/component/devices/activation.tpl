<div class="card rounded-4 bg-tertiary text-light px-5 py-3 fw-normal">
    <div class="mb-4">
        ...
        <div class="d-flex flex-column gap-2">
            ...
            <div class="d-flex gap-2 align-items-center">
                <a href="/assets/apps/macos/mole_arm.dmg" class="nav-link card bg-quaternary text-light px-2 py-2"
                    style="width: 160px;">
                    <div class="d-flex justify-content-between align-items-center gap-2">
                        <div class="col-3">
                ...
                <span>or</span>
                <a href="/assets/apps/macos/mole_x86.dmg" class="nav-link card bg-quaternary text-light ps-2 py-2"
                    style="width: 160px;">
            ...
            <div>
                <a href="/assets/apps/windows/mole.exe" class="nav-link card bg-quaternary text-light px-2 py-2"
                    style="width: 160px;">
                    <div class="d-flex justify-content-between align-items-center gap-2">
                        <div class="col-3">
